...
parser.add_argument('--start', type=int, help='Download MP ids', default=0)
parser.add_argument('--end', type=int, help='Download MP ids', default=-1)
parser.add_argument('--chgcar_path', type=str, help='Download MP ids', default="/home/holywater2/crystal/dataset_mp/data")
parser.add_argument('--use_except', type=bool, help='Download MP ids', default=False)
parser.add_argument('--mpids_path', type=str, help='Download MP ids', default="./mpids_new2.json")
# fmt:on
